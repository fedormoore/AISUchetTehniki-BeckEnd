...
//    public List<LocationDto> getAllAddress(Authentication authentication) {
//        return mapperUtils.mapAll(locationRepository.findAll(), LocationDto.class);
//    }
//
//    public List<LocationDto> saveAddress(Authentication authentication, Location location) {
...
//            if (value.getId() != firm.getId()) throw new RecordExistsException("Ошибка", "Запись уже существует");
//        });
//
...
//            if (value.getId() != model.getId()) throw new RecordExistsException("Ошибка", "Запись уже существует");
//        });
//
...
//            if (value.getId() != provider.getId()) throw new RecordExistsException("Ошибка", "Запись уже существует");
//        });
//
